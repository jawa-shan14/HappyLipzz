        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-7">
            ...
            <div className="flex items-start gap-3.5">
              <div className="mt-1 text-[#007D88]">
                <MapPin className="w-5 h-5" />
              </div>
              <div className="text-[#475569] text-base leading-relaxed">
                <p className="font-medium text-[#0A2533]">{CLINIC_INFO.address.line1}</p>
            ...
            <div className="flex items-center gap-3.5 pt-1">
              <div className="text-[#007D88]">
                <Phone className="w-5 h-5" />
              </div>
              <a
                href={`tel:${CLINIC_INFO.phone.replace(/\s+/g, '')}`}
                className="text-[#0A2533] hover:text-[#007D88] text-lg font-bold transition-colors"
              >
                {CLINIC_INFO.phone}
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              ...
              <a
                id="contact-call-btn"
                href={`tel:${CLINIC_INFO.phone.replace(/\s+/g, '')}`}
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#007D88] hover:bg-[#006B74] text-white font-semibold text-sm transition-all shadow-2xs hover:shadow-xs text-center"
              >
                Call Now
              </a>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full border border-slate-200 hover:border-[#007D88] bg-white text-[#0A2533] hover:text-[#007D88] font-medium text-sm transition-all shadow-2xs text-center"
              >
                Get Directions
              </a>
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#007D88] hover:bg-[#006B74] text-white font-semibold text-sm transition-all shadow-2xs hover:shadow-xs text-center cursor-pointer"
              >
                Book Appointment
              </button>
            </div>
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-3xl overflow-hidden shadow-lg border border-slate-200 aspect-4/3 sm:aspect-16/11 bg-[#E8ECE9] group">
              ...
              <div className="absolute top-3 left-3 right-3 sm:right-auto sm:max-w-xs bg-white/98 backdrop-blur-xs rounded-lg shadow-md p-3.5 border border-slate-200 text-xs">
