      ...
      >
        ...
        <div className="bg-[#007D88] text-white px-6 sm:px-8 py-6 flex items-start justify-between">
          <div>
            ...
            <p className="text-white/80 text-xs mt-0.5">Hebbal, Dasarahalli, Bengaluru</p>
          </div>
          <button
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-3">
              <div className="w-9 h-9 rounded-full bg-[#E5F5F6] flex items-center justify-center text-[#007D88] shrink-0">
                <Sparkles className="w-4 h-4" />
              </div>
              <div>
                <h4 className="font-bold text-sm text-[#0A2533]">Sterilization & Hygiene</h4>
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-sm text-[#0A2533]">Comfort-First Care</h4>
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-sm text-[#0A2533]">Modern Technology</h4>
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-sm text-[#0A2533]">Accessible Location</h4>
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 py-3 px-5 rounded-full bg-[#007D88] hover:bg-[#006B74] text-white font-semibold text-sm transition-all shadow-xs text-center cursor-pointer"
            >
              Book an Appointment
            </button>
            <a
