        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#0A2533] leading-none">
                  {CLINIC_INFO.name}
                </h3>
                <span className="text-[#64748B] text-[10px] font-semibold tracking-[0.16em] uppercase">
          ...
          <div className="md:col-span-3 space-y-4">
            <h4 className="text-xs font-bold tracking-[0.14em] uppercase text-[#64748B]">
              EXPLORE
            </h4>
            <ul className="space-y-2.5">
              <li>
                <button
                  ...
                  className="text-[#475569] hover:text-[#007D88] transition-colors cursor-pointer"
                >
                  Services
                </button>
              </li>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="text-[#475569] space-y-1 leading-relaxed">
              ...
              <p className="pt-2 font-bold text-[#0A2533]">
                <a
                  href={`tel:${CLINIC_INFO.phone.replace(/\s+/g, '')}`}
                  className="hover:text-[#007D88] transition-colors"
                >
                  {CLINIC_INFO.phone}
                </a>
              </p>
